...
def write_train_metrics(path: Path, metrics: dict[str, Any]) -> None:
    ...
    fieldnames = [
        ...
        "replay_priority_beta",
        "replay_priority_epsilon",
        "replay_priority_updates",
        "replay_priority_max",
        "replay_priority_mean",
        "replay_importance_weight_mean",
        "global_step",
        "env_frames",
        "episodes",
        "episode_reward",
        "episode_transformed_reward",
        ...
        "exploration_enabled",
        "exploration_method",
        "exploration_observation_source",
        "intrinsic_reward_scale",
        "intrinsic_reward_clip",
        "normalize_intrinsic_rewards",
        "normalize_exploration_observations",
